...
public class SeleniumBrowserStackBeforeDeploy {
	...
	public static final String USERNAME = "atishayshukla1";
	public static final String AUTOMATE_KEY = "Xy4ke7yYq3LJYyWvd8sW";
